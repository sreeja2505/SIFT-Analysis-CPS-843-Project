...
train_img = cv2.imread(r'C:\Users\saire\source\repos\SIFT-Scale-Invariant-Feature-Transform\res\to1.jpg')

query_img = cv2.imread(r'C:\Users\saire\source\repos\SIFT-Scale-Invariant-Feature-Transform\res\to2.jpg')
...
plt.title('first image -gray')


plt.figure(4)
plt.imshow(query_img_gray, cmap= 'gray')
plt.title('diff angle image -gray')
...
plt.title('diff angle image keypoints')
